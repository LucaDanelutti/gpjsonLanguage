...
public enum GpJSONKernel {
    ...
    QUERY("executeQuery", "executeQuery(file: in pointer char, n: sint64, newlineIndex: in pointer sint64, newlineIndexSize: sint64, stringIndex: in pointer sint64, leveledBitmapsIndex: in pointer sint64, levelSize: sint64, query: in pointer char, queryOffset: in pointer sint32, numQueries: sint32, resultOffsetMemory: in pointer sint32, result: out pointer sint64)", "it/necst/gpjson/kernels/query.cu"),
